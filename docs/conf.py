...
project = u'Sendprism'
copyright = u"2015, Ibtissam Tassaout"
...
man_pages = [
    ('index', 'sendprism', u'Sendprism Documentation',
     [u"Ibtissam Tassaout"], 1)
]
